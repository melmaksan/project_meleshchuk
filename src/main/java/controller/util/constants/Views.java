...
public class Views {
    ...
    public static final String ORDERS_VIEW = FOLDER + "orders.jsp";
    public static final String LOGIN_VIEW = FOLDER + "login.jsp";
    public static final String SERVICE_VIEW = FOLDER + "service.jsp";
    public static final String RESPOND_VIEW = FOLDER + "respond.jsp";
}
