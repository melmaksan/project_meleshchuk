...
public class PostFilterByServiceCommand implements ICommand {

    private static final ServiceForService serviceService = ServiceFactory.getServiceService();
    private static final Logger logger = LogManager.getLogger(PostFilterByServiceCommand.class);
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute(SERVICES, serviceService.filterByServiceType(request.getParameter(SERVICE_TYPE_PARAM)));
        return HOME_VIEW;
    }
}
