...
public class ServiceDtoConverter implements DtoConverter<Service> {
    ...
    private final static String PRICE = "tariff_price";
    private final static String SERVICE_SPECIALIST = "service_specialists";
    private final static String SERVICE_ORDERS = "service_orders";
    ...
    public Service convertToObject(ResultSet resultSet) throws SQLException {
        return Service.newBuilder()
                ...
                .addUsers(getSpecialists(resultSet.getString(SERVICE_SPECIALIST)))
                .addOrders(getOrders(resultSet.getString(SERVICE_ORDERS)))
                .build();
    }
