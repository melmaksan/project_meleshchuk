...
<head>
    ...
    <title><fmt:message key="confirmation.page"/></title>
</head>
<body>
                    ...
                    <div class="modal-content">
                        <form action="${pageContext.request.contextPath}/site/user/orders" method="post">
                            ...
                            <div class="modal-header bg-light text-black-50 justify-content-center">
                                <h3 class="modal-title pl-1"><fmt:message key="confirmation"/></h3>
                            </div>
                            ...
                            <div class="modal-body">
                                <div class="container">
                                    ...
                                    <table class="table">
                                        ...
                                        <tr>
                                            <th scope="row"><fmt:message key="service.type"/>:</th>
                                            <td class="text-center">${requestScope.service.description}</td>
                                        </tr>
                                        <tr>
                                            <th scope="row"><fmt:message key="service.title"/>:</th>
                                            <td class="text-center">${requestScope.service.title}</td>
                                        </tr>
                                        <tr>
                                            <th scope="row"><fmt:message key="duration"/>:</th>
                                            <td class="text-center">${requestScope.service.minutes}min</td>
                                        </tr>
                                        <tr>
                            ...
                            <div class="modal-footer justify-content-between px-4">
                                <c:if test="${sessionScope.user.user}">
                                    <a class="btn btn-outline-secondary ml-3"
                                       ...
                                       role="button" id="confButton"><fmt:message key="back"/></a>
