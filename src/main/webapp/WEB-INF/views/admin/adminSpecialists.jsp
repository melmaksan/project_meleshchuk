...
<section id="section">
    <h1 class="offset-1 my-3"><fmt:message key="all"/> <fmt:message key="a.spec"/></h1>
            ...
            <tr>
                <c:if test="${sessionScope.user.admin}">
                    ...
                    <td class="col-3 py-1 ">
                        <div class="dropdown">
                            <button class="btn" id="dropdown04" data-toggle="dropdown" aria-haspopup="true"
                                    aria-expanded="false"><fmt:message key="click"/>
                            </button>
                    ...
                    <td class="col-1 pt-0 pb-1 ">
                        <form class="mt-1 mb-0" action="${pageContext.request.contextPath}/site/admin/specialists"
                              method="post">
