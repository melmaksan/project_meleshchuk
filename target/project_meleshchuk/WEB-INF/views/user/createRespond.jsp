...
<head>
    ...
    <title><fmt:message key="create.respond.page"/></title>
</head>
<body>
...
<section id="section">
    <div class="container">
        <div class="text-center mt-5 ">
            <h1><fmt:message key="create.respond"/></h1>
        </div>
                ...
                <div class="card-body p-4">
                    <form class=form-group" method="post">
                        ...
                        <div class="row">
                            <div class="col-6 mb-2">
                                <div class="form-outline">
                                    <label class="form-label"><fmt:message key="your.name"/></label>
                                    <input type="text" name="respondName" class="form-control"/>
                                </div>
                            </div>
                            <div class="col-6 mb-2">
                                <div class="form-outline">
                                    <label class="form-label"><fmt:message key="your.email"/> *</label>
                        ...
                        <div class="row">
                            <div class="col-6 mt-2">
                                <div class="form-group">
                                    <label><fmt:message key="please.rate"/> *</label>
                                    ...
                                    <div class="rating-labels d-flex justify-content-between mt-1">
                                        <label><fmt:message key="very.unlikely"/></label>
                                        <label><fmt:message key="very.likely"/></label>
                                    </div>
                                </div>
                            </div>
                            <div class="col-6 mt-2">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="form_message"><fmt:message key="message"/></label>
                        ...
                        <div class="row justify-content-center mt-2">
                            <button type="submit" class="btn btn-outline-warning"><fmt:message key="create"/></button>
                        </div>
